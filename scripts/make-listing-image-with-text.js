...
if (parameters.length !== 2) {
    console.log("usage: [image file name in] [image file name out]");
    process.exit(1);
}

const [imageFileNameIn, imageFileNameOut] = parameters;

const imageFilePathIn = path.join(listingDirectory, imageFileNameIn);
...
const altText = "Build with the Office.js API"; // Default alt text
